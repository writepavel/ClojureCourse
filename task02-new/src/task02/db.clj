...
; для отладки
(defn- pprint-data [data state-str]
  (println \newline "--------------------   " state-str "--------------------" )
  (println \newline "CONTENT OF DATA IS" \newline)
  (pprint/pprint data)
  (println \newline "--------------------" \newline))

; для отладки
;(add-watch student "\n----  STUDENT WATCH  ----  "
;           (fn [k r o n] (println k \newline) (pprint/pprint o) (println \newline "--" \newline) (pprint/pprint n))

;;(pprint-data @student "init")
